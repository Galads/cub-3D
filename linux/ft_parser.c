...
#include <error.h>
#include "errno.h"
#include "../linux/get_next_line/get_next_line.h"
#include "../linux/my_cube.h"
...
void	ft_move_trace(t_game *img, char (*world_map)[img->map_height],
				   int i, int j)
{
	int flag;
	int k;
...
//	}
	...
	ft_check_valid_map(img, list_head, world_map);
}
